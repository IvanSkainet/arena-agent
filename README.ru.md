...
### 🆕 Что нового в v3.50.0

- **Больше нет дублей вставки** — результат в ChatGPT не вставляется дважды.
- **Честный статус вставки** — успех только когда composer реально изменился.
- **Gemini Send снова работает** — добавлены submit-button селекторы для Gemini.
