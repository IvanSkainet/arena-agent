...
### 🆕 Что нового в v3.2.12

- **Исправлена гонка в rate limiter** — v2 rate limiter теперь чистит общий `_rl_v2_store` внутри `_rl_v2_lock`, убирая реальное окно конкурентной мутации в `check_rate_limit_v2()`.
