...
- **Нет дублей controls в Claude** — controls только на ответах ассистента, не на процитированных инструкциях пользователя.
- **Улучшена отзывчивость Gemini** — сканирование не клонирует большие узлы ответа без необходимости.
