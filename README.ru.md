...
- **Detection Claude восстановлен** — tool blocks ассистента снова находятся (сообщения пользователя исключены).
- **Быстрее Send на Gemini** — частый опрос жмёт Send как только она активна, убирая задержку вставки/отправки.
