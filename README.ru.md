...
### 🆕 Что нового в v3.44.0

- **Упрощённый alpha UX** — inline controls остаются основным workflow; нестабильный latest-only/floating режим убран из popup.
- **Clear Page Controls** — можно вручную очистить inline toolbars на текущей странице чата.
