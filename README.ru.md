...
### 🆕 Что нового в v3.48.0

- **Исправлен ChatGPT JSONL parsing** — single-line склеенные tool blocks теперь парсятся.
- **Clear Page Controls стал обратимым** — reload, новый чат или Show Page Controls возвращают скрытые controls.
- **Структурированная вставка результата** — результат вставляется как fenced code block, чтобы contenteditable composers сохраняли JSON.
