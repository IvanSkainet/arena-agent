...
- **Live Tailnet bridge fetch исправлен**: extension host permissions теперь включают `https://*.tail328f18.ts.net/*`.
- **Диагностика bridge fetch улучшена**: `Failed to fetch` errors показывают bridge URL/path.
- **Local bridge support не изменён**: permissions для `127.0.0.1` и `localhost` остались.
