...
### 🆕 Что нового в v3.43.0

- **Floating latest controls** — latest-only mode теперь использует один fixed toolbar для latest detected block вместо inline controls в истории AI Studio.
- **Меньше virtualized-DOM странностей** — убирает duplicate inline toolbars и layout drift в lazy-loaded chats.
