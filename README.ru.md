...
- **Claude detection стабилизирован по реальным Scan Page diagnostics**: `[data-test-render-count]` теперь единственный Claude message selector.
- **Claude user echoes отфильтрованы**: процитированные инструкции, начинающиеся с `You said:`, больше не получают ложные controls.
- **Claude smoke target**: известная тестовая страница должна показывать 3 assistant controls вместо 4 controls вместе с user-цитатой.
