...
- **Detection Claude восстановлен** широкими надёжными селекторами.
- **Диагностика селекторов в Scan Page** — счётчики совпадений по каждому селектору делают отладку адаптеров data-driven.
