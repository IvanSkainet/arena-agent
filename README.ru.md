...
### 🆕 Что нового в v3.32.0

- **Endpoint генерации инструкций для расширения** — `GET /v1/extension/instructions` возвращает стабильные Arena или JSONL tool-use prompts для обычных web chats.
- **Кнопки копирования инструкций в popup** — можно скопировать Arena-native или MCP SuperAssistant-compatible JSONL инструкции прямо из browser extension popup.
- **End-to-end настройка chat workflow стала практичнее** — указали bridge URL/token, скопировали инструкции в AI Studio/ChatGPT/Kimi/Qwen, AI выдал tool block, Arena выполнила его, результат вставляется обратно.
