...
### 🆕 Что нового в v3.42.0

- **Fix latest-only при reload** — если latest-only уже включён, extension выбирает один визуально последний candidate до mounting controls.
- **Меньше duplicate toolbar state** — stale controls чистятся вокруг выбранного host при reload/virtualized-history scans в AI Studio.
