...
- **Workspace UI v2** — во вкладке Workspace теперь появились profile notes, important lessons и recent activity поверх уже существующих planner, ReAct/reflection и file watcher controls.
- **Dashboard bootstrap обновлён** — `/gui` теперь автоматически подгружает Workspace v2 asset bundle и wiring.
- **593 теста проходят**, без регрессий.
