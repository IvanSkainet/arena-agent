...
### 🆕 Что нового в v3.68.0

- **Editor-aware Auto insert**: Auto теперь оставляет ProseMirror-like редакторы на native `insertText`, чтобы ChatGPT и Claude сохраняли многострочную структуру.
- **Gemini fast path scoped**: быстрый `directDomPreWrap` path ограничен Gemini Web `rich-textarea`, где он подтверждён как быстрый и структурный.
- **AI Studio protected**: AI Studio остаётся на native insertion и не наследует fast path Gemini Web.
