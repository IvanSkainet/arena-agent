...
- **Поддержка Claude smoke** — селекторы для claude.ai сообщений, composer и Send.
- **Фикс отзывчивости Gemini** — idle-троттлинг сканирования, без постоянных пересканов при стриминге.
