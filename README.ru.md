...
### 🆕 Что нового в v3.45.0

- **Scan Page diagnostics** — extension может проверить active chat page и показать adapter, candidates, parsed blocks, tools, controls и snippets.
- **Основа для cross-site debugging** — scan results сохраняются в history для side-panel inspection перед Gemini/ChatGPT adapter expansion.
