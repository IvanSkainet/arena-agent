...
- **Workspace dashboard surface v1** — в `/gui` появилась отдельная вкладка **Workspace** для active profile context, planner output, bounded ReAct runs, reflection и управления file watcher'ами.
- **Документация по дашборду обновлена** — README / README.ru теперь отражают расширенный набор вкладок, включая Workspace и Control.
- **588 тестов проходят**, без регрессий.
