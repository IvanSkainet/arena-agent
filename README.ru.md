...
### 🆕 Что нового в v3.40.0

- **Лучше latest-only controls** — extension оставляет визуально нижний видимый toolbar, а не последний DOM block, который смонтировал AI Studio.
- **Чище toolbar UI** — компактные pill-кнопки, primary Run action, короткий статус и пользовательский label `Send`.
