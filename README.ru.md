...
### 🆕 Что нового в v3.49.0

- **Исправлена многострочная вставка** — результат вставляется в ChatGPT/Gemini как настоящий multi-line JSON, а не одной схлопнутой строкой.
