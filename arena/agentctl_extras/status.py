...
def run_status(args=[]):
    ...
    if p8765 == "LISTEN":
        ...
        try:
            import urllib.request
            req = urllib.request.Request("http://127.0.0.1:8765/mcp",  # nosemgrep: insecure-request-object -- loopback URL (127.0.0.1); encryption over the loopback interface is meaningless.
