...
from arena.desktop.cli.common import have, os, run, subprocess, time
    ...
    for wm_cmd, wm_name in [
        ...
        if have(wm_cmd):
            ...
            subprocess.Popen(
                ...
                shell=True  # nosec B602,B604 -- shq() quote-escapes DISPLAY; backgrounding via & requires shell.  # nosemgrep: subprocess-shell-true -- legitimate CLI-side helper (see bandit B602 nosec on the same line for the specific rationale)
            )
