...
_MEDIUM_TOOLS = {
    ...
    "custom.create", "custom.remove", "code_session.write", "tool_foundry.publish", "code_project.promote_tool", "code_run.promote_tool", "runtime.install", "code_session.stop", "code_session.stop_all", "code_project.create", "code_project.write", "code_project.remove", "code_project.deps_install",
}
