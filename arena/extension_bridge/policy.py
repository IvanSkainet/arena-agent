...
_SAFE_TOOLS = {
    ...
    "custom.list",
    "runtime.probe", "runtime.list", "code_project.list", "code_project.read", "code_run.info", "code_artifact.read",
}
_MEDIUM_TOOLS = {
    ...
    "custom.create", "custom.remove", "runtime.install", "code_project.create", "code_project.write", "code_project.remove", "code_project.deps_install",
}
