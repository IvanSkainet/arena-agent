...
PROJECT_TOOLS = [
    {"name": "code.project.create", "description": "Create a persistent Code Workbench project under ARENA_AGENT_HOME/code-projects.", "inputSchema": {"type": "object", "properties": {"name": {"type": "string"}, "files": {"type": "array"}, "overwrite": {"type": "boolean", "default": False}}, "required": ["name"], "additionalProperties": False}},
    {"name": "code.project.list", "description": "List persistent Code Workbench projects.", "inputSchema": {"type": "object", "properties": {}, "additionalProperties": False}},
    {"name": "code.project.write", "description": "Write a file in a Code Workbench project.", "inputSchema": {"type": "object", "properties": {"name": {"type": "string"}, "path": {"type": "string"}, "content": {"type": "string"}, "encoding": {"type": "string", "enum": ["utf-8", "base64"], "default": "utf-8"}}, "required": ["name", "path", "content"], "additionalProperties": False}},
    {"name": "code.project.read", "description": "Read a file from a Code Workbench project.", "inputSchema": {"type": "object", "properties": {"name": {"type": "string"}, "path": {"type": "string"}, "max_bytes": {"type": "integer", "default": 100000}}, "required": ["name", "path"], "additionalProperties": False}},
    {"name": "code.project.remove", "description": "Remove a Code Workbench project.", "inputSchema": {"type": "object", "properties": {"name": {"type": "string"}}, "required": ["name"], "additionalProperties": False}},
    {"name": "code.project.run", "description": "Run a persistent Code Workbench project through the operator-owned code.run posture fence.", "inputSchema": {"type": "object", "properties": {"name": {"type": "string"}, "lang": {"type": "string", "default": "python3"}, "entry": {"type": "string"}, "argv": {"type": "array", "items": {"type": "string"}}, "stdin": {"type": "string"}, "artifacts": {"type": "array", "items": {"type": "string"}}, "timeout": {"type": "integer"}}, "required": ["name", "entry"], "additionalProperties": False}},
]
