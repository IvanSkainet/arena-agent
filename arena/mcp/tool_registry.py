...
MCP_TOOLS = [
    ...
    {"name": "desktop.window_action", "description": "Manipulate a desktop window: move, resize, minimize, maximize, restore, close, center, move to another display, or toggle fullscreen, with optional dry-run target resolution.",
     "inputSchema": {"type": "object", "properties": {"action": {"type": "string", "enum": ["minimize", "restore", "maximize", "unmaximize", "fullscreen", "unfullscreen", "close", "center", "move_to_display", "move", "resize", "move_resize"]}, "id": {"type": "string"}, "title": {"type": "string"}, "class": {"type": "string"}, "desktop_file": {"type": "string"}, "resource_name": {"type": "string"}, "pid": {"type": "integer"}, "display": {"type": "string"}, "target_display": {"type": "string"}, "x": {"type": "integer"}, "y": {"type": "integer"}, "width": {"type": "integer"}, "height": {"type": "integer"}, "verify": {"type": "boolean", "default": True}, "timeout_ms": {"type": "integer", "default": 1000}, "dry_run": {"type": "boolean", "default": False}}, "required": ["action"]}},
