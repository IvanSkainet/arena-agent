...
MCP_TOOLS = [
    ...
    {"name": "mission.compose", "description": "Compose a planner-backed mission draft from a goal, context, and optional mission template.",
     "inputSchema": {"type": "object", "properties": {"goal": {"type": "string"}, "context": {"type": "string"}, "constraints": {"type": "array", "items": {"type": "string"}}, "max_steps": {"type": "integer", "default": 8}, "memory_profile": {"type": "string"}, "title": {"type": "string"}, "template": {"type": "string"}}, "required": ["goal"]}},
    ...
    {"name": "mission.propose", "description": "Run a bounded agentic proposal flow, reflect on it, and return a planner-backed mission draft with optional creation/run.",
     "inputSchema": {"type": "object", "properties": {"goal": {"type": "string"}, "context": {"type": "string"}, "constraints": {"type": "array", "items": {"type": "string"}}, "max_steps": {"type": "integer", "default": 8}, "max_iterations": {"type": "integer", "default": 4}, "memory_profile": {"type": "string"}, "url": {"type": "string"}, "title": {"type": "string"}, "template": {"type": "string"}, "notes": {"type": "string"}, "create": {"type": "boolean", "default": False}, "run_now": {"type": "boolean", "default": False}, "mission_id": {"type": "string"}, "overwrite": {"type": "boolean", "default": False}, "timeout": {"type": "integer", "default": 180}}, "required": ["goal"]}},
    {"name": "mission.run", "description": "Run a persisted mission by mission_id using the built-in mission manager.",
     "inputSchema": {"type": "object", "properties": {"mission_id": {"type": "string"}, "step": {"type": "integer"}, "timeout": {"type": "integer", "default": 180}}, "required": ["mission_id"]}},
