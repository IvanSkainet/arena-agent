...
PUBLIC_ENDPOINTS = [
    ...
    "GET /v1/missions", "GET /v1/mission/show?name=", "GET /v1/mission/status?name=", "GET /v1/mission/report?name=", "GET /v1/mission/history?name=", "GET /v1/mission/lineage?name=", "GET /v1/mission/catalog?q=&state=&template=&has_report=&limit=&offset=", "GET /v1/mission/templates",
