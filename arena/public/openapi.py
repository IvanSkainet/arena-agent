...
def build_openapi_spec(ctx) -> dict:
    ...
    spec: dict = {
        ...
        "paths": {
            ...
            "/v1/mission/propose": {"post": {"summary": "Run a bounded agentic proposal flow and return a planner-backed mission bundle", "tags": ["Planner"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"goal": {"type": "string"}, "context": {"type": "string"}, "constraints": {"type": "array", "items": {"type": "string"}}, "max_steps": {"type": "integer", "default": 8}, "max_iterations": {"type": "integer", "default": 4}, "memory_profile": {"type": "string"}, "url": {"type": "string"}, "title": {"type": "string"}, "template": {"type": "string"}, "notes": {"type": "string"}, "create": {"type": "boolean", "default": False}, "run_now": {"type": "boolean", "default": False}, "mission_id": {"type": "string"}, "overwrite": {"type": "boolean", "default": False}, "timeout": {"type": "integer", "default": 180, "minimum": 0, "maximum": 86400}}, "required": ["goal"]}}}}, "responses": {"200": {"description": "Mission proposal bundle"}}}},
            ...
            "/v1/mission/rerun": {"post": {"summary": "Rerun a mission, optionally just the last failed step", "tags": ["Planner"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"mission_id": {"type": "string"}, "step": {"type": "integer"}, "failed_only": {"type": "boolean", "default": False}, "timeout": {"type": "integer", "default": 180, "minimum": 0, "maximum": 86400}}, "required": ["mission_id"]}}}}, "responses": {"200": {"description": "Mission rerun result"}}}},
            "/v1/mission/recover": {"post": {"summary": "Build a recovery bundle for a persisted mission, with optional rerun and follow-up composition", "tags": ["Planner"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"mission_id": {"type": "string"}, "notes": {"type": "string"}, "failed_only": {"type": "boolean", "default": True}, "step": {"type": "integer"}, "timeout": {"type": "integer", "default": 180, "minimum": 0, "maximum": 86400}, "rerun_now": {"type": "boolean", "default": False}, "compose_followup": {"type": "boolean", "default": False}, "create_followup": {"type": "boolean", "default": False}, "followup_goal": {"type": "string"}, "followup_title": {"type": "string"}, "followup_mission_id": {"type": "string"}, "max_steps": {"type": "integer", "default": 8}, "memory_profile": {"type": "string"}, "template": {"type": "string"}, "overwrite": {"type": "boolean", "default": False}}, "required": ["mission_id"]}}}}, "responses": {"200": {"description": "Mission recovery bundle"}}}},
            "/v1/mission/followup": {"post": {"summary": "Compose a next mission from an existing mission's artifacts using agentic analysis", "tags": ["Planner"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"mission_id": {"type": "string"}, "goal": {"type": "string"}, "title": {"type": "string"}, "notes": {"type": "string"}, "constraints": {"type": "array", "items": {"type": "string"}}, "max_steps": {"type": "integer", "default": 8}, "max_iterations": {"type": "integer", "default": 4}, "memory_profile": {"type": "string"}, "template": {"type": "string"}, "url": {"type": "string"}, "create": {"type": "boolean", "default": False}, "run_now": {"type": "boolean", "default": False}, "followup_mission_id": {"type": "string"}, "overwrite": {"type": "boolean", "default": False}, "timeout": {"type": "integer", "default": 180, "minimum": 0, "maximum": 86400}}, "required": ["mission_id"]}}}}, "responses": {"200": {"description": "Mission follow-up bundle"}}}},
            "/v1/mission/iterate": {"post": {"summary": "Run a full mission iteration loop: recover current mission, then optionally compose/create/run a follow-up mission", "tags": ["Planner"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"mission_id": {"type": "string"}, "notes": {"type": "string"}, "failed_only": {"type": "boolean", "default": True}, "step": {"type": "integer"}, "timeout": {"type": "integer", "default": 180, "minimum": 0, "maximum": 86400}, "rerun_now": {"type": "boolean", "default": False}, "compose_followup": {"type": "boolean", "default": False}, "create_followup": {"type": "boolean", "default": False}, "run_followup": {"type": "boolean", "default": False}, "followup_goal": {"type": "string"}, "followup_title": {"type": "string"}, "followup_mission_id": {"type": "string"}, "constraints": {"type": "array", "items": {"type": "string"}}, "max_steps": {"type": "integer", "default": 8}, "max_iterations": {"type": "integer", "default": 4}, "memory_profile": {"type": "string"}, "template": {"type": "string"}, "url": {"type": "string"}, "overwrite": {"type": "boolean", "default": False}}, "required": ["mission_id"]}}}}, "responses": {"200": {"description": "Mission iteration bundle"}}}},
            "/v1/mission/schedules/tick": {"post": {"summary": "Manually execute due mission schedules", "tags": ["Planner"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"schedule_id": {"type": "string"}, "id": {"type": "string"}, "force": {"type": "boolean", "default": False}, "limit": {"type": "integer", "default": 10}, "timeout": {"type": "integer", "default": 180, "minimum": 0, "maximum": 86400}}}}}}, "responses": {"200": {"description": "Mission schedule tick result"}}}},
