...
def build_openapi_spec(ctx) -> dict:
    return {
        ...
        "paths": {
            ...
            "/v1/desktop/screenshot": {"get": {"summary": "Take desktop screenshot", "tags": ["Desktop"], "parameters": [{"name": "format", "in": "query", "schema": {"type": "string", "enum": ["base64", "png", "jpeg", "jpg", "webp"], "default": "base64"}}, {"name": "display", "in": "query", "schema": {"type": "string"}}, {"name": "scale", "in": "query", "schema": {"type": "number"}}, {"name": "max_width", "in": "query", "schema": {"type": "integer"}}, {"name": "quality", "in": "query", "schema": {"type": "integer", "default": 80}}], "responses": {"200": {"description": "Screenshot data"}}}},
            ...
            "/v1/desktop/focus": {"post": {"summary": "Focus a desktop window by id or semantic filters", "tags": ["Desktop"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"id": {"type": "string"}, "title": {"type": "string"}, "class": {"type": "string"}, "desktop_file": {"type": "string"}, "resource_name": {"type": "string"}, "pid": {"type": "integer"}, "display": {"type": "string"}, "verify": {"type": "boolean", "default": True}, "timeout_ms": {"type": "integer", "default": 1500}, "dry_run": {"type": "boolean", "default": False}}}}}}, "responses": {"200": {"description": "Focus result"}, "404": {"description": "No window matched"}}}},
