...
def build_openapi_spec(ctx) -> dict:
    return {
        ...
        "paths": {
            ...
            "/v1/fs/edit": {"patch": {"summary": "Find-and-replace in a text file (surgical edit)", "tags": ["Files"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"path": {"type": "string"}, "old_text": {"type": "string"}, "new_text": {"type": "string"}, "replace_all": {"type": "boolean", "default": False}, "preview": {"type": "boolean", "default": False, "description": "If true, do not write yet; return a preview_id and diff for confirmation."}}, "required": ["path", "old_text", "new_text"]}}}}, "responses": {"200": {"description": "Edit result or preview result"}, "404": {"description": "File not found / old_text not found"}, "409": {"description": "old_text matches multiple times or file changed since preview"}}}},
            "/v1/fs/edit/apply": {"post": {"summary": "Apply a previously created fs.edit preview", "tags": ["Files"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"preview_id": {"type": "string"}}, "required": ["preview_id"]}}}}, "responses": {"200": {"description": "Applied edit with rollback_id"}, "404": {"description": "Preview not found or expired"}, "409": {"description": "File changed since preview"}}}},
            "/v1/fs/edit/rollback": {"post": {"summary": "Rollback a previously applied safe edit", "tags": ["Files"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"rollback_id": {"type": "string"}, "force": {"type": "boolean", "default": False}}, "required": ["rollback_id"]}}}}, "responses": {"200": {"description": "Rollback result"}, "404": {"description": "Rollback not found or expired"}, "409": {"description": "File changed since apply"}}}},
