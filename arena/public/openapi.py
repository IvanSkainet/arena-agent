...
def build_openapi_spec(ctx) -> dict:
    ...
    spec: dict = {
        ...
        "paths": {
            ...
            "/v1/fs/edit": {"patch": {"summary": "Find-and-replace in a text file", "tags": ["Files"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"path": {"type": "string"}, "old_text": {"type": "string"}, "new_text": {"type": "string"}, "replace_all": {"type": "boolean", "default": False}, "preview": {"type": "boolean", "default": False}}, "required": ["path", "old_text", "new_text"]}}}}, "responses": {"200": {"description": "Preview or applied result"}, "403": {"description": "Path outside the home directory"}}}},
            "/v1/fs/edit/apply": {"post": {"summary": "Apply a previewed safe edit", "tags": ["Files"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"preview_id": {"type": "string"}}, "required": ["preview_id"]}}}}, "responses": {"200": {"description": "Applied edit"}, "404": {"description": "Preview not found or expired"}}}},
            "/v1/fs/edit/rollback": {"post": {"summary": "Rollback a safe edit", "tags": ["Files"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"rollback_id": {"type": "string"}, "force": {"type": "boolean", "default": False}}, "required": ["rollback_id"]}}}}, "responses": {"200": {"description": "Rollback result"}, "404": {"description": "Rollback not found or expired"}}}},
            "/v1/fs/view": {"post": {"summary": "Read a text file", "tags": ["Files"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"path": {"type": "string"}, "view_range": {"type": "array", "items": {"type": "integer"}, "maxItems": 2}}, "required": ["path"]}}}}, "responses": {"200": {"description": "View result"}, "403": {"description": "Path outside the home directory"}}}},
            "/v1/fs/create": {"post": {"summary": "Create a new text file", "tags": ["Files"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"path": {"type": "string"}, "content": {"type": "string"}}, "required": ["path", "content"]}}}}, "responses": {"200": {"description": "Create result"}, "403": {"description": "Create path outside the home directory"}}}},
            "/v1/memory": {
            ...
            "/v1/browser/head": {"get": {"summary": "HTTP HEAD request", "tags": ["Browser"], "responses": {"200": {"description": "HEAD result"}, "400": {"description": "Missing or unusable url parameter"}}}},
            ...
            "/v1/events": {"get": {"summary": "WebSocket real-time event stream", "description": "A WebSocket handshake, not a JSON operation: send `Upgrade: websocket` and `Connection: Upgrade`. A plain GET is answered 426 rather than upgraded, and an unauthenticated one is refused with 401 before the handshake.", "tags": ["Events"], "parameters": [{"name": "Upgrade", "in": "header", "required": True, "schema": {"type": "string", "enum": ["websocket"]}}, {"name": "Connection", "in": "header", "required": True, "schema": {"type": "string", "enum": ["Upgrade"]}}], "responses": {"101": {"description": "Switching protocols: the event stream is open"}, "426": _error_response("Not a WebSocket handshake -- send the Upgrade and Connection headers")}}},
