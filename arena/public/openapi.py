...
def build_openapi_spec(ctx) -> dict:
    ...
    spec: dict = {
        ...
        "paths": {
            ...
            "/v1/exec": {"post": {"summary": "Execute command", "tags": ["Exec"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"cmd": {"type": "string"}, "timeout": {"type": "integer", "default": 30}, "cwd": {"type": "string"}}, "required": ["cmd"]}}}}, "responses": {"200": {"description": "Command result"}, "403": {"description": "Refused by the active profile, or a cwd outside the root"}, "408": {"description": "The command outlived its timeout and was killed"}}}},
            "/v1/upload": {"post": {"summary": "Upload binary file", "tags": ["Files"], "parameters": [{"name": "path", "in": "query", "required": True, "schema": {"type": "string"}}], "responses": {"200": {"description": "Upload result"}, "400": {"description": "Missing path"}, "403": {"description": "Upload path outside the home directory"}}}},
            "/v1/download": {"get": {"summary": "Download file", "tags": ["Files"], "parameters": [{"name": "path", "in": "query", "required": True, "schema": {"type": "string"}}], "responses": {"200": {"description": "File bytes"}, "400": {"description": "Missing path"}, "403": {"description": "Path outside the home directory"}}}},
