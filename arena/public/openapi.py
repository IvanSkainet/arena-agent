...
def build_openapi_spec(ctx) -> dict:
    return {
        ...
        "paths": {
            ...
            "/v1/react": {"post": {"summary": "Run a bounded reason-act-observe loop using safe observation steps", "tags": ["Agentic"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"goal": {"type": "string"}, "context": {"type": "string"}, "constraints": {"type": "array", "items": {"type": "string"}}, "max_iterations": {"type": "integer", "default": 4}, "memory_profile": {"type": "string"}, "url": {"type": "string"}}, "required": ["goal"]}}}}, "responses": {"200": {"description": "ReAct run output"}}}},
            "/v1/reflect": {"post": {"summary": "Reflect on a prior run and produce concerns, missing evidence, and next steps", "tags": ["Agentic"], "requestBody": {"content": {"application/json": {"schema": {"type": "object", "properties": {"goal": {"type": "string"}, "run": {"type": "object"}, "notes": {"type": "string"}, "outcome": {"type": "string"}}}}}}, "responses": {"200": {"description": "Reflection output"}}}},
            "/v1/watch/files": {
