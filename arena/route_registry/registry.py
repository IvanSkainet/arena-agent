...
ROUTES: list[Route] = [
    ...
    ('GET'   , '/v1/mcp/servers'                                 , 'handle_v1_mcp_servers'                      , 'compat', None),
    ('POST'  , '/v1/mcp/custom/remove'                           , 'handle_v1_mcp_custom_remove'              , 'compat', None),
    ...
    ('POST'  , '/v1/control/halt'                                , 'handle_v1_control_halt'                     , 'desktop', None),
    ('POST'  , '/v1/control/unhalt'                              , 'handle_v1_control_unhalt'                   , 'desktop', None),
    ('GET'   , '/v1/control/yolo'                                , 'handle_v1_control_yolo_get'                 , 'desktop', None),
    ('POST'  , '/v1/control/yolo'                                , 'handle_v1_control_yolo_set'                 , 'desktop', None),
    ...
    ('POST'  , '/v1/relay/send'                                  , 'handle_v1_relay_send'                       , 'domain', None),
    ('GET'   , '/v1/relay/poll'                                  , 'handle_v1_relay_poll'                       , 'domain', None),
    ('POST'  , '/v1/relay/reply'                                 , 'handle_v1_relay_reply'                      , 'domain', None),
    ('GET'   , '/v1/relay/replies'                               , 'handle_v1_relay_replies'                    , 'domain', None),
    ('GET'   , '/v1/relay/status'                                , 'handle_v1_relay_status'                     , 'domain', None),
    ('GET'   , '/v1/game/boe/status'                             , 'handle_v1_boe_status'                       , 'domain', None),
    ('POST'  , '/v1/game/boe/wait_inbox'                         , 'handle_v1_boe_wait_inbox'                   , 'domain', None),
    ('GET'   , '/v1/game/boe/read_turn'                          , 'handle_v1_boe_read_turn'                    , 'domain', None),
    ('POST'  , '/v1/game/boe/write_json'                         , 'handle_v1_boe_write_json'                   , 'domain', None),
    ('POST'  , '/v1/game/boe/complete_turn'                      , 'handle_v1_boe_complete_turn'                , 'domain', None),
    ('POST'  , '/v1/game/boe/fail_turn'                          , 'handle_v1_boe_fail_turn'                    , 'domain', None),
    ('POST'  , '/v1/game/boe/repair_turn'                        , 'handle_v1_boe_repair_turn'                  , 'domain', None),
