...
def build_memory_resource_browser_runtimes(g: MutableMapping[str, Any]) -> dict[str, Any]:
    ...
    registry.update({
        ...
        "_mission_lineage_sync": resource_runtime.mission_lineage_sync,
        "_mission_family_sync": resource_runtime.mission_family_sync,
        "_mission_catalog_sync": resource_runtime.mission_catalog_sync,
        "_mission_schedules_sync": resource_runtime.mission_schedules_sync,
        "_mission_schedule_save_sync": resource_runtime.mission_schedule_save_sync,
        "_mission_schedule_delete_sync": resource_runtime.mission_schedule_delete_sync,
