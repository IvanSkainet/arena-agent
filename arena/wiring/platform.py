...
def build_system_handlers(ctx: SystemWiringContext) -> dict[str, Callable[..., Any]]:
    ...
    return {
        ...
        "handle_v1_autonomy_posture_get": handlers.autonomy_posture_get,
        "handle_v1_autonomy_posture_set": handlers.autonomy_posture_set,
    }
...
def build_admin_handlers(ctx: AdminWiringContext) -> dict[str, Callable[..., Any]]:
    ...
    return {
        ...
        "handle_v1_access":               handlers.access_describe,
