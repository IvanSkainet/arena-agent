...
const SLASH_COMMANDS = {
  ...
  "/sysinfo": { cmd: "agentctl sys status",                  hint: "CPU/RAM/Disk summary" },
  "/audit":   { cmd: "agentctl audit tail 50",             hint: "Recent audit log entries" },
  "/facts":   { cmd: "agentctl mem get all",                  hint: "List memory facts" },
  "/tasks":   { cmd: "agentctl task ls",                   hint: "List queued/active tasks" },
  "/ip":      { cmd: "ip addr",                    hint: "Show local + public IP" },
  "/dns":     { cmd: "getent hosts ",                  hint: "DNS lookup (append host)" },
