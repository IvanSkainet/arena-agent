...
- **`POST /v1/desktop/window_action`**: Move, resize, minimize, maximize, restore, close, or toggle fullscreen on a resolved window. Supports `dry_run` target resolution before acting.
