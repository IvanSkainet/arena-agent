...
- Tests: `624 passed`
- MCP tools: `57`
- Route objects in aiohttp app: `323`
- Distinct method/path routes excluding auto-HEAD: `218`
...
- mission composition and inspection v2 via REST + MCP (`mission.templates`, `mission.status`, `mission.report`, `mission.history`, `mission.compose`, `mission.propose`, `mission.create`, `mission.run`, `mission.rerun`)
