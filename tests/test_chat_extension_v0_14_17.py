...
def test_versions_pinned_to_0_14_17():
    assert 'ARENA_CONTENT_SCRIPT_VERSION = "0.14.43"' in _read("content.js") \
        or "ARENA_CONTENT_SCRIPT_VERSION = '0.14.43'" in _read("content.js")
    assert json.loads(_read("manifest.json"))["version"] == "0.14.43"
    assert "return '0.14.43';" in _read("insert_strategies.js")
    assert "Current extension version: `0.14.43`" in _read("README.md")
