...
def test_parser_has_unlabeled_fence_pattern():
    ...
    assert ("v4.51.4" in src or "v4.52.0" in src) or "v4.51.3" in src or "v4.52.0" in src or "v0.14.33" in src or "v0.14.32" in src or "v0.14.34" in src
