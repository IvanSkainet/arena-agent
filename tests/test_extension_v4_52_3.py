"""v0.14.44 / v4.52.3 tests: Scan Now regression fix + ZeroTier URL update.
...
def test_manifest_version_bumped():
    assert json.loads(_read(CHAT_EXT / "manifest.json"))["version"] == "0.14.44"
...
def test_readme_mentions_v4_52_3():
    ...
    assert ("0.14.44" in src or "0.14.44" in src)
