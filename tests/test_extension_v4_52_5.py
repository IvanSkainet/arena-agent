"""v0.14.39 / v4.52.5 tests: supported-host ranker for Scan Now.
...
def test_readme_mentions_v4_52_5():
    ...
    assert "v4.52.5" in src


def test_constants_version_bumped():
    assert 'VERSION = "4.52.5"' in _read(REPO_ROOT / "arena" / "constants.py")


def test_pyproject_version_bumped():
    assert 'version = "4.52.5"' in _read(REPO_ROOT / "pyproject.toml")
